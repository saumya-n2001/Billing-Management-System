 ...
 * @author saumy
 */
public class DeleteStocks extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (row==1)
        {
            ...
            try{
                ...
                {
                    JOptionPane.showMessageDialog(null," product deleted seccessfully");
                    tm.setRowCount(0);
                    loadProductDetails();
               return;
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteStocks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteStocks().setVisible(true);
            }
        });
    }
